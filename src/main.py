...
class ModelConfig:
    ...
    save_res: bool = True
    results_filename: str = 'results_base_binary_cleaned_azbyka.csv'
    ...
    def from_args(cls):
        ...
        parser.add_argument('--results-filename', default='results_base_binary_cleaned_azbyka.csv',
...
class EpochshipVerification:
    ...
    def load_dataset(self,  
                     path: str = 'file_versions/azbyka/ocs_cs_data_cleaned_azbyka.json'
